	...
	SubShader
	{
		...
		Pass
		{
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				float4 lerpResult6 = lerp( _Color1 , _Color2 , abs( ( IN.ase_color.r + ( ceil( ( frac( mulTime2 ) - 0.5 ) ) * -1.0 ) ) ));
				
				float3 BakedAlbedo = 0;
				float3 BakedEmission = 0;
				float3 Color = lerpResult6.rgb;
				float Alpha = 1;
...
/*ASEBEGIN
Version=18900
-3591;338;1430;935;522.16;637.3029;1;True;False
...
ASEEND*/
//CHKSM=4158AA24153FBE95B75DDADD37995FE9D41B8007