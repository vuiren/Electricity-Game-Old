	...
	SubShader
	{
		...
		Pass
		{
						 ...
						 ) : SV_Target
			{
				...
				float3 tex2DNode3 = UnpackNormalScale( tex2D( _Normal, uv_Normal ), 1.0f );
				float3 tanToWorld0 = float3( WorldTangent.x, WorldBiTangent.x, WorldNormal.x );
				float3 tanToWorld1 = float3( WorldTangent.y, WorldBiTangent.y, WorldNormal.y );
				float3 tanToWorld2 = float3( WorldTangent.z, WorldBiTangent.z, WorldNormal.z );
				float3 tanNormal4 = tex2DNode3;
				float3 worldNormal4 = float3(dot(tanToWorld0,tanNormal4), dot(tanToWorld1,tanNormal4), dot(tanToWorld2,tanNormal4));
				float2 temp_cast_0 = (_Tiling).xx;
				float4 triplanar6 = TriplanarSampling6( _noise, WorldPosition, WorldNormal, 1.0, temp_cast_0, 1.0, 0 );
				float saferPower31 = max( ( ( worldNormal4.y * triplanar6.x ) + _Snow_Range ) , 0.0001 );
				...
				float3 Normal = lerpResult25;
				float3 Emission = 0;
				float3 Specular = 0.5;
				float Metallic = (lerpResult17).x;
				float Smoothness = (lerpResult17).w;
				float Occlusion = (lerpResult17).y;
				float Alpha = 1;
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				float3 worldNormal4 = float3(dot(tanToWorld0,tanNormal4), dot(tanToWorld1,tanNormal4), dot(tanToWorld2,tanNormal4));
				float2 temp_cast_0 = (_Tiling).xx;
				float4 triplanar6 = TriplanarSampling6( _noise, WorldPosition, ase_worldNormal, 1.0, temp_cast_0, 1.0, 0 );
				float saferPower31 = max( ( ( worldNormal4.y * triplanar6.x ) + _Snow_Range ) , 0.0001 );
				float temp_output_34_0 = saturate( pow( saferPower31 , _Snow_Contrast ) );
				float4 lerpResult13 = lerp( tex2D( _Albedo, uv_Albedo ) , _Color0 , temp_output_34_0);
...
/*ASEBEGIN
Version=18900
-3591;338;1430;935;4055.283;1233.279;3.587976;True;False
...
Node;AmplifyShaderEditor.SamplerNode;3;-1942.711,98.01595;Inherit;True;Property;_Normal;Normal;2;1;[Normal];Create;True;0;0;0;False;0;False;-1;None;25bc83601e67a684aba46c2c2de636c0;True;0;True;bump;Auto;True;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;32;-1913.749,858.3746;Inherit;False;Property;_Snow_Range;Snow_Range;5;0;Create;True;0;0;0;False;0;False;0;0.67;-1;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SamplerNode;1;-1881.928,-311.7789;Inherit;True;Property;_Albedo;Albedo;0;0;Create;True;0;0;0;False;0;False;-1;None;591c84a4622d99f4081d8e7f9ee0a683;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SaturateNode;34;-1306.149,776.0744;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.ColorNode;14;-1274.818,478.5828;Inherit;False;Property;_Color0;Color 0;7;0;Create;True;0;0;0;False;0;False;0,0,0,0;1,1,1,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.Vector4Node;24;-1394.732,256.896;Inherit;False;Constant;_Vector0;Vector 0;8;0;Create;True;0;0;0;False;0;False;0,1,0,0.9;0,1,0,0.9;0;5;FLOAT4;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SamplerNode;2;-1874.928,-113.7789;Inherit;True;Property;_Mask;Mask;1;0;Create;True;0;0;0;False;0;False;-1;None;193d6b20c1735f84e98b6a97dbd935cb;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.Vector3Node;27;-1169.304,840.2502;Inherit;False;Constant;_nor;nor;9;0;Create;True;0;0;0;False;0;False;0,0,1;0,0,1;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
...
WireConnection;36;3;18;0
WireConnection;36;4;21;0
WireConnection;36;5;20;0
ASEEND*/
//CHKSM=FC9ACE54292408E48063E7C5058557EB4E8A6814