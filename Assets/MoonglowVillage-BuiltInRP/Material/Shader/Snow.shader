	...
	SubShader
	{
		...
		Pass
		{
			...
			VertexOutput VertexFunction( VertexInput v  )
			{
				...
				#endif
				float3 vertexValue = ( ( tex2Dlod( _TextureSample0, float4( uv_TextureSample0, 0, 0.0) ).r * v.ase_normal ) * _Float0 );
				#ifdef ASE_ABSOLUTE_VERTEX_POS
						 ...
						 ) : SV_Target
			{
				...
				float fresnelNdotV4 = dot( normalize( WorldNormal ), WorldViewDirection );
				...
				float3 triplanar5 = TriplanarSampling5( _Texture0, WorldPosition, WorldNormal, 1.0, temp_cast_1, 1.0, 0 );
				float3 tanTriplanarNormal5 = mul( ase_worldToTangent, triplanar5 );
				
				float2 temp_cast_2 = (_Specular_Tile).xx;
				float4 triplanar33 = TriplanarSampling33( _Texture1, WorldPosition, WorldNormal, 1.0, temp_cast_2, 1.0, 0 );
				...
				float3 Normal = tanTriplanarNormal5;
				float3 Emission = 0;
		...
		Pass
		{
								 ...
								 )
			{
				...
				float fresnelNdotV4 = dot( WorldNormal, WorldViewDirection );
				float f04 = _FresnelF1;
				float fresnelNode4 = ( f04 + ( 1.0 - f04 ) * pow( max( 1.0 - fresnelNdotV4 , 0.0001 ), 5 ) );
				float4 lerpResult3 = lerp( _Color_1 , _Color_2 , fresnelNode4);
...
/*ASEBEGIN
Version=18900
-3591;338;1430;935;428.5917;344.0721;1;True;False
...
Node;AmplifyShaderEditor.ColorNode;8;-825.2917,-229.9301;Inherit;False;Property;_Color_2;Color_2;7;1;[HDR];Create;True;0;0;0;False;0;False;0,0,0,0;2.118547,2.118547,2.118547,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.TexturePropertyNode;7;-1659.887,70.79479;Inherit;True;Property;_Texture0;Texture 0;9;1;[Normal];Create;True;0;0;0;False;0;False;None;None;True;bump;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
...
Node;AmplifyShaderEditor.Vector3Node;47;222.1489,525.6647;Inherit;False;Constant;_Vector0;Vector 0;11;0;Create;True;0;0;0;False;0;False;0,1,0;0,0,0;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
...
WireConnection;53;9;37;0
WireConnection;53;4;36;0
WireConnection;53;8;48;0
ASEEND*/
//CHKSM=16BFD4411B2350183CDCB9A21CECAEF8BED928AC